...
Revision ID: 5de029db6a46
Revises: 
Create Date: 2024-09-15 09:57:01.285159
...
def upgrade():
    ...
    sa.Column('delivery_status', sa.Enum('received', 'in-transit', 'delivered', 'canceled'), nullable=False),
